...
const routes = [
    ...
    {
        path: 'products',
        loadChildren: () => Promise.all(/*! import() | products-page-products-page-module */[__webpack_require__.e("default~login-page-login-page-module~products-page-products-page-module~profile-page-profile-page-mo~9d3f62ab"), __webpack_require__.e("products-page-products-page-module")]).then(__webpack_require__.bind(null, /*! ./products-page/products-page.module */ "DJ0e")).then((m) => m.ProductsPageModule),
    },
    {
        path: 'profile',
        canActivate: [_interceptors_aut_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]],
        loadChildren: () => Promise.all(/*! import() | profile-page-profile-page-module */[__webpack_require__.e("default~login-page-login-page-module~products-page-products-page-module~profile-page-profile-page-mo~9d3f62ab"), __webpack_require__.e("default~login-page-login-page-module~profile-page-profile-page-module"), __webpack_require__.e("profile-page-profile-page-module")]).then(__webpack_require__.bind(null, /*! ./profile-page/profile-page.module */ "GVwY")).then((m) => m.ProfilePageModule),
    },
    {
        path: 'about',
        loadChildren: () => Promise.all(/*! import() | ui-components-about-page-about-page-module */[__webpack_require__.e("default~login-page-login-page-module~products-page-products-page-module~profile-page-profile-page-mo~9d3f62ab"), __webpack_require__.e("ui-components-about-page-about-page-module")]).then(__webpack_require__.bind(null, /*! ./ui-components/about-page/about-page.module */ "Bryu")).then((m) => m.AboutPageModule),
    },
    {
        path: 'login',
        loadChildren: () => Promise.all(/*! import() | login-page-login-page-module */[__webpack_require__.e("default~login-page-login-page-module~products-page-products-page-module~profile-page-profile-page-mo~9d3f62ab"), __webpack_require__.e("default~login-page-login-page-module~profile-page-profile-page-module"), __webpack_require__.e("login-page-login-page-module")]).then(__webpack_require__.bind(null, /*! ./login-page/login-page.module */ "x2uj")).then((m) => m.LoginPageModule),
    },
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | login-page-login-page-module */[__webpack_require__.e("default~login-page-login-page-module~products-page-products-page-module~profile-page-profile-page-mo~9d3f62ab"), __webpack_require__.e("default~login-page-login-page-module~profile-page-profile-page-module"), __webpack_require__.e("login-page-login-page-module")]).then(__webpack_require__.bind(null, /*! ./login-page/login-page.module */ "x2uj")).then((m) => m.LoginPageModule),
...
class AuthService {
    constructor(http) {
        ...
        this.USER_KEY = 'USER';
        this.AUTH_ROUTE = 'https://api-estudy-bazar.herokuapp.com/api/auth';
